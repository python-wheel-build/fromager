...
- **Authentication support** via `GITHUB_TOKEN` environment variable
...
# GitHub token for API authentication (prevents rate limiting)
...
- Setting `GITHUB_TOKEN` for GitHub API calls
